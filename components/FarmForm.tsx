...
type Tab = 'basic' | 'facility' | 'service' | 'support' | 'annual';
        ...
        <form onSubmit={handleSubmit} className="flex-grow flex flex-col">
            <div className="border-b border-gray-200 mb-6">
                <nav className="-mb-px flex space-x-6">
                    <TabButton tab="basic" label="기본/기업농"/>
                    <TabButton tab="facility" label="시설 정보"/>
                    <TabButton tab="service" label="서비스 정보"/>
                    <TabButton tab="support" label="지원 사업"/>
                    <TabButton tab="annual" label="연간 데이터"/>
                </nav>
            </div>
            ...
            <div className="flex-grow overflow-y-auto pr-4 -mr-4 space-y-8">
                {activeTab === 'basic' && (
                    ...
                    {farmData.basicInfo.isCorporate && farmData.corporateFarmDetails && (
                        ...
                        <fieldset className="p-4 border rounded-md">
                            ...
                            <div className="space-y-4">
                                {farmData.corporateFarmDetails.consultationLogs.map((log, i) => (
                                    <div key={log.id} className="p-3 bg-gray-50 rounded-md border grid grid-cols-1 md:grid-cols-2 gap-3 relative">
                                        <button type="button" onClick={() => removeConsultationLog(i)} className="absolute top-2 right-2 text-red-500 hover:text-red-700 p-1"><TrashIcon /></button>
                            ...
                            <button type="button" onClick={addConsultationLog} className="mt-4 flex items-center text-orange-600 hover:text-orange-800 font-semibold">
                ...
                {activeTab === 'facility' && (
                    <fieldset className="p-4 border rounded-md">
                        ...
                        <div className="mt-4 flex items-center space-x-4 p-2 rounded-md hover:bg-gray-100">
                ...
                {activeTab === 'service' && (
                    <fieldset className="p-4 border rounded-md">
                        ...
                        <div className="flex items-center space-x-4 p-2 rounded-md hover:bg-gray-100">
                    ...
                    <fieldset className="p-4 border rounded-md">
                        ...
                        {farmData.supportPrograms.map((p, i) => {
                            ...
                            <div key={p.id} className="p-3 bg-gray-50 rounded-md border grid grid-cols-2 md:grid-cols-3 gap-3 relative">
                                <button type="button" onClick={() => removeSupportProgram(i)} className="absolute top-2 right-2 text-red-500 hover:text-red-700 p-1"><TrashIcon /></button>
                        ...
                        <button type="button" onClick={addSupportProgram} className="mt-4 flex items-center text-orange-600 hover:text-orange-800 font-semibold">
                ...
                {activeTab === 'annual' && (
                    <fieldset className="p-4 border rounded-md">
                        ...
                        {farmData.annualData.map((d, i) => (
                            ...
                            <button type="button" onClick={() => removeAnnualData(i)} className="absolute top-2 right-2 text-red-500 hover:text-red-700 p-1"><TrashIcon /></button>
                        ...
                        <button type="button" onClick={addAnnualData} className="mt-4 flex items-center text-orange-600 hover:text-orange-800 font-semibold">
